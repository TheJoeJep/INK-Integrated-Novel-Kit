...
**Three good reasons to use an iconic character:**
...
**Identify where they're weakest. That's the arc.**
...
**The tragic version is precise:** not *arrogance causes failure in act three.* The character must
have **already learned the lesson and consciously rejected it.**

---

## 4. The three tests

### Has the flaw's cost been shown?

**Before you can pay it off.** Missed opportunities, stalled growth, relationships breaking. You
cannot cash a cost you never established.

**And is it double-edged?** Hubris is also self-confidence. That's what makes a flaw worth keeping
until the end.
...
**The Star Wars escalation model:**

| Film | Beat |
|---|---|
| One | Vader introduced; Luke never faces him |
...
continuity (the Craig Bond model) works without every book demanding a full arc.
...
── FINDINGS ──
  The arc is identified but not yet earned. Two gaps: the flaw's cost is
  unestablished, and there's no answer to why he'd act differently by the end.
```
...
- **Ask whether an arc is needed** before designing one
- **Refuse to proceed without an axis.** "He grows" isn't an arc
- **Press on the WHY.** It's where arcs fail and where authors skip
- **Flag arc inflation** if everyone in the cast is transforming
- **Offer options for arc content**, never one

## Related

`/new-character` · `/motivation` · `/write`
